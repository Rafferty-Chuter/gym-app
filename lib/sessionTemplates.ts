...
function matchesSlot(ex: ExerciseMetadata, slot: SessionSlot): boolean {
  return hasAnyRole(ex, slot.acceptableRoles) && hasAllTags(ex, slot.acceptableTags);
}
...
export const SESSION_TEMPLATES: SessionTemplate[] = [
  ...
  },
  {
    ...
    requiredSlots: [
      ...
      {
        slotId: "push_chest_isolation",
        slotLabel: "Chest isolation / fly",
        acceptableRoles: ["isolation"],
        acceptableTags: ["chest"],
        preferredFatigue: ["low", "moderate"],
        preferredOrder: 3,
      ...
      {
        slotId: "push_triceps_isolation",
        slotLabel: "Triceps isolation",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["triceps"],
        preferredFatigue: ["low"],
        preferredOrder: 4,
        required: true,
      },
    ...
    optionalSlots: [
      {
        slotId: "push_secondary_press",
        slotLabel: "Secondary chest press",
        acceptableRoles: ["secondary_compound", "machine_compound", "main_compound"],
        acceptableTags: ["push", "horizontal_push"],
        preferredFatigue: ["moderate", "high"],
        preferredOrder: 3,
        required: false,
      },
      {
        ...
        slotLabel: "Extra chest or triceps isolation",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["push"],
        preferredFatigue: ["low"],
        preferredOrder: 5,
      ...
      {
        slotId: "push_side_delt_iso",
        slotLabel: "Side delt / lateral raise",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["shoulders"],
        preferredFatigue: ["low"],
        preferredOrder: 6,
    ...
    coverageRules: [
      ...
      {
        id: "push_chest_isolation_presence",
        description: "Direct chest isolation",
        minMatches: 1,
        requiredTagsAll: ["chest"],
        requiredRolesAny: ["isolation"],
      },
      {
        id: "push_triceps_isolation_presence",
        description: "Direct triceps isolation",
        minMatches: 1,
        requiredTagsAll: ["triceps"],
        requiredRolesAny: ["isolation", "accessory"],
      },
    ],
    warnings: [
      {
        ...
        triggers: {
          missingCoverageRuleIdsAny: [
            ...
            "push_chest_isolation_presence",
            "push_triceps_isolation_presence",
          ],
        },
      },
      {
  ...
  },
  {
    ...
    requiredSlots: [
      ...
      {
        slotId: "pull_rear_upper_back_iso",
        slotLabel: "Rear delt / upper-back isolation",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["back", "pull"],
        preferredFatigue: ["low", "moderate"],
        preferredOrder: 3,
      ...
      {
        slotId: "pull_biceps_isolation",
        slotLabel: "Biceps isolation",
        acceptableRoles: ["isolation"],
        acceptableTags: ["biceps", "pull"],
        preferredFatigue: ["low"],
        preferredOrder: 4,
        required: true,
      },
    ...
    optionalSlots: [
      {
        ...
        slotLabel: "Extra row, pulldown, or curl",
        acceptableRoles: ["secondary_compound", "machine_compound", "isolation"],
        acceptableTags: ["pull"],
        preferredFatigue: ["low", "moderate"],
        preferredOrder: 5,
    ...
    coverageRules: [
      ...
      {
        id: "pull_biceps_direct",
        description: "Direct biceps isolation",
        minMatches: 1,
        requiredTagsAll: ["biceps"],
        requiredRolesAny: ["isolation"],
      },
      {
        id: "pull_upper_back_iso",
        description: "Rear delt / upper-back isolation",
        minMatches: 1,
        requiredTagsAll: ["back", "pull"],
        requiredRolesAny: ["isolation", "accessory"],
      },
    ],
    warnings: [
      {
        ...
        triggers: {
          missingCoverageRuleIdsAny: [
            "pull_vertical_presence",
            "pull_horizontal_presence",
            "pull_biceps_direct",
            "pull_upper_back_iso",
          ],
        },
  ...
  },
  {
    ...
    requiredSlots: [
      {
        ...
        slotLabel: "Primary push (chest / pressing)",
        acceptableRoles: ["main_compound", "secondary_compound", "machine_compound"],
        // Catalog tags very few movements as horizontal_push; upper+push compounds still satisfy intent.
        acceptableTags: ["upper", "push"],
        preferredFatigue: ["moderate", "high"],
        preferredOrder: 1,
        required: true,
      },
      {
        ...
        slotLabel: "Primary pull (row or vertical pull)",
        acceptableRoles: ["main_compound", "secondary_compound", "machine_compound"],
        // Only one library row carries horizontal_pull; upper+pull compounds cover rows + pulldowns + chins.
        acceptableTags: ["upper", "pull"],
        preferredFatigue: ["moderate", "high"],
        preferredOrder: 2,
        required: true,
      },
      {
        ...
        slotLabel: "Second compound (vertical push or pull)",
        acceptableRoles: ["main_compound", "secondary_compound", "machine_compound"],
    ...
    optionalSlots: [
      ...
      {
        slotId: "upper_triceps_iso",
        slotLabel: "Triceps isolation",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["upper", "triceps"],
        preferredFatigue: ["low"],
        preferredOrder: 5,
        required: false,
      },
      {
        slotId: "upper_second_accessory",
        slotLabel: "Extra upper isolation (rear delt, chest fly, etc.)",
        acceptableRoles: ["isolation", "accessory"],
        acceptableTags: ["upper"],
        preferredFatigue: ["low"],
        preferredOrder: 6,
    ...
    warnings: [
      ...
      {
        kind: "too_bloated",
        message: "Upper session should usually stay in the 4-7 range.",
        triggers: { exerciseCountGreaterThan: 8 },
      },
    ],
  },
