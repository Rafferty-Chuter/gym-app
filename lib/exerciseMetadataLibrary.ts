...
export const EXERCISE_METADATA_LIBRARY: ExerciseMetadata[] = [
  ...
  },
  {
    ...
    lengthBias: "neutral",
    tags: ["chest", "push", "upper", "horizontal_push", "incline", "upper_chest"],
  },
  {
    id: "cable_chest_fly",
  ...
  },
  {
    ...
    movementPattern: "elbow_extension_overhead",
    role: "isolation",
    equipment: ["cable_machine_or_dumbbells"],
    fatigueCost: "low",
    substitutes: ["skullcrusher", "cable_overhead_extension", "ez_bar_overhead_extension"],
    loadCategory: "isolation_machine_cable",
    recommendedRepRange: "8-15",
    lengthBias: "stretch_biased",
    tags: ["arms", "push", "upper", "full_body", "triceps", "triceps_long_head"],
  },
  {
    id: "triceps_pushdown",
    ...
    equipment: ["cable_machine"],
    fatigueCost: "low",
    substitutes: ["triceps_overhead_extension", "machine_dip", "reverse_grip_pushdown"],
    loadCategory: "isolation_machine_cable",
    recommendedRepRange: "10-15",
    lengthBias: "neutral",
    tags: ["arms", "push", "upper", "full_body", "triceps", "triceps_lateral_head"],
  },
  {
    id: "jm_press",
    name: "JM Press",
    ...
    equipment: ["barbell", "bench", "rack"],
    fatigueCost: "moderate",
    substitutes: ["triceps_overhead_extension", "triceps_pushdown", "flat_barbell_bench_press"],
    loadCategory: "free_weight_compound",
    recommendedRepRange: "6-12",
    lengthBias: "neutral",
